...
const ReviewForm = ({data, updateFieldHandler}: any) => {
  return (
    <div className="review-form">
      ...
      <div className="form-control">
        ...
        <textarea name="comment" id="comment" placeholder="Conte como foi a sua experiência.." required
        value={data.comment || ""}
